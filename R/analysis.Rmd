...
scenariol <- c("SSP1", "SSP2", "SSP5")
results <- map_dfr(scenariol, ~ 
                     process_raster_data(paste0("./data/rasters/RCP19_", .x, "_2050_bio.tif"), 
                                         .x, dat))
...
results %>%
  ...
  xlab("Bioenergy expansion (rescaled- was in Mha)")+
  ylab("Cumulative range loss (rescaled - was in number of pixels)")->p1
